      ...
      <div class="playlist" @click="hide" v-show="visible && playlist.length">
        <div class="list-wrapper" @click.stop>
          <div class="list-header">
            <h1 class="title">
              <i class="icon" @click="changeMode" :class="modeIcon"></i>
          ...
          <scroll ref="scrollRef" class="list-content">
            <transition-group ref="songListRef" name="list" tag="ul">
              <li
                class="item"
...
export default {
  ...
  setup() {
    ...
    function scrollToCurrent() {
      ...
      const currentRef = songListRef.value.$el.children[index];
      scrollRef.value.scroll.scrollToElement(currentRef, 0);
    }
